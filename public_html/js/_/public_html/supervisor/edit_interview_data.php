...
<body>
    ...
    <section>
        <h1>Editar Evaluacion de la Entrevista</h1>
        <p class="inf">Se puede cambiar la calificacion y resultado</p>
        <form action="../php/edit_interview_result.php" id="formFilter" method="POST">
            <div class="grupo">
                <input type="hidden" name="id" value=<?= $resultado_aplicantes['id']?>>
            </div>
            <div class="grupo">
                <label for="cal">Calificación</label>
                <input type="number" id="cal" name="cal" min="0" value=<?= $resultado_aplicantes['calification_interview']?>>
            </div>
            <div class="grupo">
