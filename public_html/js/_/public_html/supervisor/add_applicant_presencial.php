...
if(@$_SESSION['id_user'] && @$_SESSION['id_rol'] == 2 && $result['state_etr'] == 1):?>
    <?php
...
<body>
    ...
    <section>
        <div class="contenedor_form">
            <form action="../php/reg_applicant_presencial.php" id="formPostular"  method="POST" name="form_postulante" enctype="multipart/form-data">
